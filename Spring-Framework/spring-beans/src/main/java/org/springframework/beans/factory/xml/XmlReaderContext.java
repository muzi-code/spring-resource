...
public class XmlReaderContext extends ReaderContext {
	...
	/**
	 * 构造方法
	 * 		XmlBeanDefinitionReader -> createReaderContext 会把自己本身传入
	 * 		使得XmlReaderContext持有XmlBeanDefinitionReader对象
	 *
	...
	/**
	 * BeanDefinitionRegistry理解：
	 *
	 * 		BeanDefinition的注册器，解析好的beandefinition要缓存起来
	 *
